...
As part of my Bachelor's minor thesis, I worked on multimodal emotion-cause analysis in conversations, exploring GNNs, LLMs, and retrieval-augmented methods in the context of the [SemEval 2024](https://arxiv.org/abs/2403.04798){:target="_blank" rel="noopener"} shared task.

I have also worked as a researcher at the [HCTL Lab, TU Munich](https://www.edu.sot.tum.de/en/hctl/home/){:target="_blank" rel="noopener"}, led by [Prof. Dr. Enkelejda Kasneci](https://scholar.google.com/citations?user=bZVkVvoAAAAJ){:target="_blank" rel="noopener"}, where I was supervised by [Yao Rong](https://yaorong0921.github.io/homepage/){:target="_blank" rel="noopener"} on self-supervised learning for scanpaths. I was a full-time summer research intern at TUM in 2023, funded by the [DAAD-WISE Scholarship](https://www.daad.in/en/find-funding/scholarship-database/?type=a&q=&status=1&subject=F&onlydaad=1&detail_to_show=0&target=4&origin=4&pg=1&detail_to_show=50015295){:target="_blank" rel="noopener"}. Before that, I was a summer research intern at IIIT Allahabad under [Prof. Anupam Agarwal](https://scholar.google.co.in/citations?user=mVXjhhgAAAAJ&hl=en){:target="_blank" rel="noopener"}, where I worked on autism diagnosis from visual attention patterns. I was also mentored by [Hitesh Hinduja](https://hitesh-hinduja.mystrikingly.com/){:target="_blank" rel="noopener"} on my first research [paper](https://www.iosrjournals.org/iosr-jce/papers/Vol25-issue1/Ser-1/E2501013749.pdf){:target="_blank" rel="noopener"} on scene text localisation.

I have also had the opportunity to lead my team, sCUDA_Divers, to the Grand Finale of the [Smart India Hackathon](https://www.sih.gov.in/sih2023){:target="_blank" rel="noopener"} in both 2022 and 2023. Our project on super-resolution of digital elevation models culminated in a paper at [IEEE IGARSS 2023](https://ieeexplore.ieee.org/abstract/document/10283196){:target="_blank" rel="noopener"}. -->
